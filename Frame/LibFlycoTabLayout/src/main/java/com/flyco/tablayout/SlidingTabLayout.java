...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextBottom = ta.getBoolean(R.styleable.SlidingTabLayout_tl_textBottom, false);
        mTextBottomMargin = ta.getDimension(R.styleable.SlidingTabLayout_tl_text_bottom_margin, dp2px(0));
        mTextScale = ta.getBoolean(R.styleable.SlidingTabLayout_tl_textScale, false);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setTextSelsize(float textsize) {
        this.mSelTextsize = sp2px(textsize);
        updateTabStyles();
    }
