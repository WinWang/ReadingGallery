...
public class CommonTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    private boolean mTextScale;
    private int mTextSelectColor;
    private int mTextUnselectColor;
    private int mTextBold;
    private boolean mTextAllCaps;
    private boolean mTextBottom;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSelTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textSelsize, sp2px(13f));
        ...
        mTextBottom = ta.getBoolean(R.styleable.CommonTabLayout_tl_textBottom, false);
        mTextBottomMargin = ta.getDimension(R.styleable.CommonTabLayout_tl_text_bottom_margin, dp2px(0));
        mTextScale = ta.getBoolean(R.styleable.CommonTabLayout_tl_textScale, false);
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (mTextScale) {
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? mSelTextsize : mTextsize);
            } else {
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            LinearLayout tabWrapLayout = (LinearLayout) tabView.findViewById(R.id.ll_tap);
            if (mTextBottom) {
                RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
                lp.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
                lp.addRule(RelativeLayout.CENTER_HORIZONTAL);
                lp.addRule(RelativeLayout.CENTER_VERTICAL);
                lp.bottomMargin = dp2px(mTextBottomMargin);
                tabWrapLayout.setLayoutParams(lp);
            }
        }
    }
