...
/**
 * Created by WinWang on 2020/11/12
 * Description->修復loadSir中nestedScroll的使用
 */
public class LoadingNestedScrollView extends LinearLayout implements NestedScrollingParent2,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(LoadingNestedScrollView v, int scrollX, int scrollY,
    ...
    public LoadingNestedScrollView(@NonNull Context context) {
        this(context, null);
    }

    public LoadingNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
...
//        if (getChildCount() > 0) {
//            View child = getChildAt(0);
//            final androidx.core.widget.NestedScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
//
...
//    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final LoadingNestedScrollView nsvHost = (LoadingNestedScrollView) host;
